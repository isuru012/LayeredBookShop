...
public class CustomerModel {
    ...
    public static boolean insertCustomerData(Customer customer) throws SQLException, ClassNotFoundException {
        String sql="INSERT INTO Customer VALUES (?,?,?,?,?)";
        return CrudUtil.execute(sql,customer.getCusId(),customer.getName(),customer.getPhoneNumber(),customer.getJoindDate(),customer.getEmployeeId());
    ...
    public static boolean updateCustomer(String name, int phoneNumber, String cusId) throws SQLException, ClassNotFoundException {
        ...
        return CrudUtil.execute(sql,name,phoneNumber,cusId);
    }
